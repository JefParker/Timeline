// OBSOLETE — DO NOT RUN. Hand-appends puzzles to public/puzzles.json, which is
// now generated. Use `npm run build:puzzles` instead. Move to scripts/archive/.
console.error('add_puzzles.js is obsolete; public/puzzles.json is generated by npm run build:puzzles. Refusing to run.');
process.exit(1);
