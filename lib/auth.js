...
// 90 days. Sessions are stateless, so a token stays valid for its full TTL and
// cannot be revoked individually — rotating ADMIN_SECRET
// (scripts/rotate-admin-secret.sh) is the only way to invalidate one, and it
// signs out every session at once.
